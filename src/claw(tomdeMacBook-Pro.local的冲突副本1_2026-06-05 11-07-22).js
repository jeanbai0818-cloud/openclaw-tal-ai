...
const CLAW_MODELS = [
  ...
  { id: "kimi-k2.5",               name: "kimi-k2.5",               api: "openai-completions", baseUrl: CLAW_BASE_OPENAI, reasoning: true,  input: ["text", "image"], contextWindow: 256000,  maxTokens: 32768,  compat: OAI_COMPAT, cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 } },
  { id: "kimi-k2.6",               name: "kimi-k2.6",               api: "openai-completions", baseUrl: CLAW_BASE_OPENAI, reasoning: true,  input: ["text", "image"], contextWindow: 256000,  maxTokens: 32768,  compat: OAI_COMPAT, cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 } },
  { id: "doubao-seed-2.0-lite",    name: "doubao-seed-2.0-lite",    api: "openai-completions", baseUrl: CLAW_BASE_OPENAI, reasoning: true,  input: ["text", "image"], contextWindow: 256000,  maxTokens: 128000, compat: OAI_COMPAT, cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 } },
  { id: "doubao-seed-2.0-pro",     name: "doubao-seed-2.0-pro",     api: "openai-completions", baseUrl: CLAW_BASE_OPENAI, reasoning: true,  input: ["text", "image"], contextWindow: 256000,  maxTokens: 128000, compat: OAI_COMPAT, cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 } },
  { id: "doubao-seedream-5-0-lite", name: "doubao-seedream-5-0-lite", api: "openai-completions", baseUrl: CLAW_BASE_OPENAI, reasoning: true, input: ["text", "image"], contextWindow: 256000,  maxTokens: 128000, compat: OAI_COMPAT, cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 } },
  { id: "qwen3.5-plus",            name: "qwen3.5-plus",            api: "openai-completions", baseUrl: CLAW_BASE_OPENAI, reasoning: true,  input: ["text", "image"], contextWindow: 1000000, maxTokens: 65536,  compat: OAI_COMPAT, cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 } },
  { id: "MiniMax-M2.7",            name: "MiniMax M2.7",            api: "openai-completions", baseUrl: CLAW_BASE_OPENAI, reasoning: false, input: ["text", "image"], contextWindow: 200000,  maxTokens: 8192,   compat: OAI_COMPAT, cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 } },
  { id: "gpt-5.2",                 name: "gpt-5.2",                 api: "openai-completions", baseUrl: CLAW_BASE_OPENAI, reasoning: true,  input: ["text", "image"], contextWindow: 400000,  maxTokens: 128000, compat: OAI_COMPAT, cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 } },
  { id: "gpt-5.3",                 name: "gpt-5.3",                 api: "openai-completions", baseUrl: CLAW_BASE_OPENAI, reasoning: true,  input: ["text", "image"], contextWindow: 400000,  maxTokens: 128000, compat: OAI_COMPAT, cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 } },
  { id: "gpt-5.4",                 name: "gpt-5.4",                 api: "openai-completions", baseUrl: CLAW_BASE_OPENAI, reasoning: true,  input: ["text", "image"], contextWindow: 1050000, maxTokens: 128000, compat: OAI_COMPAT, cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 } },
  { id: "gpt-5.5",                 name: "gpt-5.5",                 api: "openai-completions", baseUrl: CLAW_BASE_OPENAI, reasoning: true,  input: ["text", "image"], contextWindow: 1050000, maxTokens: 128000, compat: OAI_COMPAT, cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 } },
  { id: "gemini-3-flash",          name: "Gemini 3 Flash",          api: "openai-completions", baseUrl: CLAW_BASE_OPENAI, reasoning: true,  input: ["text", "image"], contextWindow: 400000,  maxTokens: 65536,  compat: OAI_COMPAT, cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 } },
];
